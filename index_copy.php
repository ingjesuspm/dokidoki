            ...
            <div class="lec_main_menu_content_menu lec_wht_txt text-right">
                <div class="container">
                    <ul>
                        ...
                        <li class="lec_parent"><a href="#">DokiDoki</a>
                            <ul>
                    ...
                    <div class="lec_main_menu_content_menu_copy">
                        ...
                        <div class="lec_footer_social">
                            <a href="https://www.facebook.com/dokidokichocolate"><i class="ti ti-facebook lec_icon_box"></i></a>
                            <a href="https://www.instagram.com/dokidokichocolate/"><i class="ti ti-instagram lec_icon_box"></i></a>
                            <a href="https://twitter.com/thedokidoki"><i class="ti ti-twitter lec_icon_box"></i></a>
                        </div>
                    </div>
                </div>
                <!-- container end -->
...
<!-- text comment
        ...
        <!-- Slide Down -->
        <a class="lec_scroll_down lec_go" href="#catering">
            <b></b>
    ...
    <!-- Content -->
    <section id="catering" class="lec_content">
                ...
                <div class="container text-center">
                    ...
                    <div class="row">
                        <div class="col-md-10 lec_animation_block" data-bottom-top="transform:translate3d(0px, 40px, 0px)" data-top-bottom="transform:translate3d(0px, -40px, 0px)">
                            <img src="images/doki_gift.jpg" alt="">
                        </div>
                        ...
                        <div class="col-md-5 lec_animation_block lec_animation_abs_block lec_posr lec_image_bck" data-bottom-top="transform:translate3d(0px, 0px, 0px)" data-top-bottom="transform:translate3d(0px, 40px, 0px)" data-image="images/black-1072366_1920.jpg" data-color="#eee" >
                            ...
                            <div class="lec_parallax_menu lec_image_bck lec_fixed">
                                ...
                                <p>A chocolate party sized for up to 50 people. We bring enough pretzels and sweets to make sure that each guest gets at least 3 items each! Every party is unique, and we are happy to make the Doki Doki experience at your party unique too. Just ask, and we will prepare sweets that are friendly to special diets, unique flavor combinations, and fancy colors to match your theme!</p>
                                <a href="https://squareup.com/store/dokidokichocolate/" target = "_blank" class="btn">View Our Catering Menu <i class="ti ti-truck"></i></a>
        ...
        <!-- section -->
        <section id="specials" class="lec_section lec_image_bck lec_fixed lec_section_no_overlay lec_wht_txt">
            ...
            <div class="container text-center">
                ...
                <div class="lec_icon_boxes lec_team_slider">
                    ...
                    <div class="lec_news_block text-center">
                        <span class="lec_news_img_parent"><span class="lec_news_img lec_image_bck" data-image="images/home_based.jpg"></span></span>
                        <span class="lec_title_animation lec_gold">Monday</span>
                        <span class="lec_news_title">We Do Pretzel Right</span>
                        <p>Stocked up the shop today with a couple hundred delicious pretzels.</p>  
                    </div>

                    <!-- item -->
                    <div class="lec_news_block text-center">
                        <span class="lec_news_img_parent"><span class="lec_news_img lec_image_bck" data-image="images/custom_pretzel.jpg"></span></span>
                        <span class="lec_title_animation lec_gold">Thuesday</span>
                        <span class="lec_news_title">It's That Pretzel Feeling</span>
                        <p>We love making custom chocolate pretzels to fit your party theme!</p>  
                    </div>

                    <!-- item -->
                    <div class="lec_news_block text-center">
                        <span class="lec_news_img_parent"><span class="lec_news_img lec_image_bck" data-image="images/fancy_pretzel.jpg"></span></span>
                        <span class="lec_title_animation lec_gold">Wednesday</span>
                        <span class="lec_news_title">Like Pretzel. Like Never Before.</span>
                        <p>If you are looking for a pretzel catering you are in the right place</p>  
                    </div>

                    <!-- item -->
                    <div class="lec_news_block text-center">
                        <span class="lec_news_img_parent"><span class="lec_news_img lec_image_bck" data-image="images/matcha_pretzel.jpg"></span></span>
                        <span class="lec_title_animation lec_gold">Thursday</span>
                        <span class="lec_news_title">More Pretzel Please</span>
                        <p>Matcha pretzels now come with dark chocolate drizzle!.</p>  
                    </div>

                    <!-- item -->
                    <div class="lec_news_block text-center">
                        <span class="lec_news_img_parent"><span class="lec_news_img lec_image_bck" data-image="images/party_bucket.jpg"></span></span>
                        <span class="lec_title_animation lec_gold">Friday</span>
                        <span class="lec_news_title">Happiness is Pretzel-Shaped</span>
                        <p>Party Buckets are now available at SEED Ventures!.</p>  
                    </div>

                    <!-- item -->
                    <div class="lec_news_block text-center">
                        <span class="lec_news_img_parent"><span class="lec_news_img lec_image_bck" data-image="images/smore.jpg"></span></span>
                        <span class="lec_title_animation lec_gold">Sat Sun</span>
                        <span class="lec_news_title">Pretzel Wanted</span>
                        <p>Spontaneous smores experiment at a totally awesome gig.</p>  
                    </div>
        ...
        <!-- section -->
        <section id="products" class="lec_section lec_wht_txt">
            ...
            <div class="container-fluid text-center">
                ...
                <div class="lec_slider_single lec_slider_single_giant lec_wht_txt lec_lm_type_i" data-dots="true" data-autoplay="true">
                    ...
                    <div class="lec_lm_type_i_item">
                        <img src="images/vase_pretzel.jpg" alt="">
                        ...
                        <div class="lec_lm_type_i_item_desc lec_image_bck text-left" data-bottom-top="transform:translate3d(0px, 0px, 0px)" data-top-bottom="transform:translate3d(0px, -50px, 0px)" data-color="#333" data-image="images/black-1072366_1920.jpg">
                            ...
                            <div class="lec_lm_type_i_item_desc_cont">
                                <h2 class="lec_neon_title">Supreme</h2>
                                <div class="lec_lm_type_i_item_price">$2 - $20</div>
                                <p>Peanut Butter Triple Chocolate</p>
                                <h4>Composition</h4>
                                <p class="lec_lm_type_i_item_ingr">The most popular of the excellent pretzels, this natural favorite is composed of a base layer of dark chocolate, slathered in all natural peanut butter, drizzled in milk and then white chocolate. </p>
                            </div>
                        </div>
                    </div>

                    <div class="lec_lm_type_i_item">
                        <img src="images/tripledark_pretzel.jpg" alt="">
                        
                        <div class="lec_lm_type_i_item_desc lec_image_bck text-left" data-bottom-top="transform:translate3d(0px, 0px, 0px)" data-top-bottom="transform:translate3d(0px, -50px, 0px)" data-color="#333" data-image="images/black-1072366_1920.jpg">
  
                            <div class="lec_lm_type_i_item_desc_cont">
                                <h2 class="lec_neon_title">Darked</h2>
                                <div class="lec_lm_type_i_item_price">$1 - $10</div>
                                <p>Delicious Double Chocolate.</p>
                                <h4>Composition</h4>
                                <p class="lec_lm_type_i_item_ingr">The entry-level pretzel. Delicious Double Chocolate pretzels come in 9 combinations of one base layer of dark, milk, or white chocolate drizzled in dark, milk, or white chocolate.</p>
                            </div>
                        </div>
                    </div>

                    <div class="lec_lm_type_i_item">
                        <img src="images/coup_pretzel.jpg" alt="">
                        
                        <div class="lec_lm_type_i_item_desc lec_image_bck text-left" data-bottom-top="transform:translate3d(0px, 0px, 0px)" data-top-bottom="transform:translate3d(0px, -50px, 0px)" data-color="#333" data-image="images/black-1072366_1920.jpg">
  
                            <div class="lec_lm_type_i_item_desc_cont">
                                <h2 class="lec_neon_title">Veg</h2>
                                <div class="lec_lm_type_i_item_price">$3 - $30</div>
                                <p>Vegan Delight.</p>
                                <h4>Composition</h4>
                                <p class="lec_lm_type_i_item_ingr">This pretzel is made with chocolate that contains no milk products. It has two layers of dark chocolate, rolled in golden brown sugar for a touch of sweetness, texture, and color, then drizzled in dark chocolate.</p>
                            </div>
                        </div>
                    </div>
        ...
        <!-- section -->
        <section id="story" class="lec_section lec_section_no_overlay lec_wht_txt">
                ...
                <div class="container">
                    ...
                    <div class="row row_mb_100">
                        <div class="col-md-9 lec_animation_block" data-bottom-top="transform:translate3d(0px, 40px, 0px)" data-top-bottom="transform:translate3d(0px, -40px, 0px)">
                            <img src="images/dokidoki.jpg" alt="">
                        </div>
                        ...
                        <div class="col-md-5 lec_animation_block lec_animation_abs_block lec_posr lec_image_bck" data-bottom-top="transform:translate3d(0px, -40px, 0px)" data-top-bottom="transform:translate3d(0px, 40px, 0px)" data-image="images/black-1072366_1920.jpg" data-color="#333" >
                            ...
                            <div class="lec_parallax_menu lec_image_bck lec_fixed">
                                <h2 class="lec_neon_title">Starters</h2>
                                ...
                                <div class="lec_parallax_menu_mini lec_parallax_menu_mini_feaut">
                                    <div class="lec_parallax_menu_mini_title clearfix">
                                        ...
                                        <div class="lec_parallax_menu_mini_price">$30</div>
                                    </div>
                                    <p>They have 12 Delicious Double Chocolate pretzels and 3 of each of Peanut Butter Tripple Chocolate, Matcha, Coffee and Cream, and Pumpkin Pie!</p>
                                </div>

                                <div class="lec_parallax_menu_mini">
                                    <div class="lec_parallax_menu_mini_title clearfix">
                                        <h3>Matcha Japanese Green Tea</h3>
                                        <div class="lec_menu_spacer"></div>
                                        <div class="lec_parallax_menu_mini_price">$2</div>
                                    </div>
                                    <p>This unique treat is made of a base layer matcha-infused white chocolate which is then drizzled in white chocolate for a super smooth experience</p>
                                </div> 
                                ...
                                <div class="lec_parallax_menu_mini">
                                    <div class="lec_parallax_menu_mini_title clearfix">
                                        ...
                                        <div class="lec_menu_spacer"></div>
                                        <div class="lec_parallax_menu_mini_price">$3</div>
                                    </div>
                                    <p>This amazing masterpiece has a base layer of dark chocolate, slathered in hazelnut spread, rolled in ground coffee, then drizzled in milk and white chocolate. So, so, good...</p>
                                </div>
                    ...
                    <div class="row text-left">
                        <div class="col-md-5 lec_animation_block lec_animation_abs_block lec_posl lec_image_bck" data-bottom-top="transform:translate3d(0px, 40px, 0px)" data-top-bottom="transform:translate3d(0px, -40px, 0px)" data-image="images/black-1072366_1920.jpg" data-color="#333" >
                            ...
                            <div class="lec_parallax_menu lec_image_bck lec_fixed">
                                <h2 class="lec_neon_title">Chocolate</h2>
                                
                                <div class="lec_parallax_menu_mini">
                                    <div class="lec_parallax_menu_mini_title clearfix">
                                        <h3>Delicious Double Chocolate</h3>
                                        <div class="lec_menu_spacer"></div>
                                        <div class="lec_parallax_menu_mini_price">$1</div>
                                    </div>      
                                    <p>Delicious Double Chocolate pretzels come in 9 combinations of one base layer of dark, milk, or white chocolate drizzled in dark, milk, or white chocolate.</p>
                                </div>
                                ...
                                <div class="lec_parallax_menu_mini lec_parallax_menu_mini_feaut">
                                    <div class="lec_parallax_menu_mini_title clearfix">
                                        <h3>Titan Pretzel</h3>
                                        <div class="lec_menu_spacer"></div>
                                        <div class="lec_parallax_menu_mini_price">$5</div>
                                    </div>
                                    <p>Dark chocolate, slathered in peanut butter, rolled in chopped mixed nuts, then drizzled in enough milk and white chocolate to keep it from crumbling under its own weight.</p>
                                </div> 
                                ...
                                <div class="lec_parallax_menu_mini lec_parallax_menu_mini_feaut">
                                    ...
                                    <p>This wondrous masterpiece has a base layer of pumpkin spice-infused white chocolate, drizzled in white chocolate, rolled in a little bit of light brown sugar, drizzled one more time with white chocolate, and then splashed with pumpkin spice. It tastes like happiness...</p>
                                </div>
                        ...
                        <div class="col-md-8 col-md-offset-4 lec_animation_block" data-bottom-top="transform:translate3d(0px, -40px, 0px)" data-top-bottom="transform:translate3d(0px, 40px, 0px)">
                            <img src="images/dokidoki3.jpg" alt="">
                        </div>
            ...
            <div class="container text-center">
                ...
                <div class="row">
                        ...
                        <div class="col-md-4 lec_anim_box">
                            <div class="lec_shop_item">
                                <span class="lec_shop_item_slider">
                                    <img src="images/double_chocolate.jpg" alt="">
                                </span>
                                <a href="https://squareup.com/store/dokidokichocolate/" target = "_blank" class="lec_shop_item_title">
                                    Delicious Double Chocolate
                                    <b>$1-$10</b>
                                </a>
                                <div class="lec_shop_item_links">
                                    <a href="https://squareup.com/store/dokidokichocolate/" target = "_blank">Buy It</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 lec_anim_box">
                            <div class="lec_shop_item">
                                <span class="lec_shop_item_slider">
                                    <img src="images/peanut_pretzel.jpg" alt="">
                                </span>
                                <a href="https://squareup.com/store/dokidokichocolate/" target = "_blank" class="lec_shop_item_title">
                        ...
                        <div class="col-md-4 lec_anim_box">
                            <div class="lec_shop_item">
                                <span class="lec_shop_item_slider">
                                    <img src="images/matcha_pretzel2.jpg" alt="">
                                </span>
                                <a href="https://squareup.com/store/dokidokichocolate/" target = "_blank" class="lec_shop_item_title">
						...
						<div class="col-md-4 lec_anim_box">
                            <div class="lec_shop_item">
                                <span class="lec_shop_item_slider">
                                    <img src="images/pumpkin_pretzel.jpg" alt="">
                                </span>
                                <a href="https://squareup.com/store/dokidokichocolate/" target = "_blank" class="lec_shop_item_title">
                                    Pumpkin Pie
                                    <b>$3-$30</b>
                        ...
                        <div class="col-md-4 lec_anim_box">
                            <div class="lec_shop_item">
                                <span class="lec_shop_item_slider">
                                    <img src="images/vegan_pretzel.jpg" alt="">
                                </span>
                                <a href="https://squareup.com/store/dokidokichocolate/" target = "_blank" class="lec_shop_item_title">
                                    Vegan Delight
                                    <b>$3-$30</b>
                        ...
                        <div class="col-md-4 lec_anim_box">
                            <div class="lec_shop_item">
                                <span class="lec_shop_item_slider">
                                    <img src="images/titan_pretzel.jpg" alt="">
                                </span>
                                <a href="https://squareup.com/store/dokidokichocolate/" target = "_blank" class="lec_shop_item_title">
                                    Titan Pretzel
                                    <b>$5-$50</b>
                ...
                <div class="container text-center">
                    ...
                    <div class="row">
                        <div class="col-md-9 lec_animation_block lec_map_hidden_top" data-bottom-top="transform:translate3d(0px, 40px, 0px)" data-top-bottom="transform:translate3d(0px, -40px, 0px)">
                            <img src="images/dokidoki2.jpg" alt="">
                        </div>
                        ...
                        <div class="col-md-6 lec_animation_block lec_animation_abs_block lec_posr lec_image_bck lec_wht_txt" data-bottom-top="transform:translate3d(0px, 0px, 0px)" data-top-bottom="transform:translate3d(0px, 40px, 0px)" data-image="images/black-1072366_1920.jpg" data-color="#eee" >
                            ...
                            <div class="lec_parallax_menu Directions lec_fixed">
                                ...
                                <p>344 Oxford Ave. Elyria Ohio, 44035</p>
                                <a href="mailto:dokidokichocolate@gmail.com" class="btn">Contact DokiDoki <i class="ti ti-email"></i></a>
                            </div>
                ...
                <div class="container text-center">
                    ...
                    <div class="row">
                        <div class="col-md-10 col-md-offset-2 lec_animation_block" data-bottom-top="transform:translate3d(0px, 40px, 0px)" data-top-bottom="transform:translate3d(0px, -40px, 0px)">
                            <img src="images/dokidoki4.jpg" alt="">
                        </div>
                        ...
                        <div class="col-md-6 lec_animation_block lec_animation_abs_block lec_posl lec_image_bck lec_wht_txt" data-bottom-top="transform:translate3d(0px, 0px, 0px)" data-top-bottom="transform:translate3d(0px, 40px, 0px)" data-image="images/black-1072366_1920.jpg" data-color="#eee">
                            ...
                            <div class="lec_parallax_menu lec_image_bck lec_fixed">
                                ...
                                <p>Doki Doki Chocolate combines the sensibility and attention to detail of Japanese-style confectionery with a playful American-style party-rocking attitude to craft ridiculously delicious chocolate-covered pretzels your inner child won't soon forget!</p>
                                <a href="https://squareup.com/store/dokidokichocolate/" target = "_blank" class="btn">Read More <i class="ti ti-heart"></i></a>
                            </div>
        ...
        <!-- section -->
        <section class="lec_section lec_section_lg_pd lec_image_bck lec_wht_txt" data-image="images/dokidoki12.jpg">
        ...
        <!-- section -->
        <section id="events" class="lec_section">
        ...
        <section class="lec_section">
            ...
            <div class="container-fluid text-center lec_wht_txt">
                ...
                <div class="lec_slider_single lec_wht_txt lec_lm_type_i" data-dots="false" data-autoplay="true">
                    ...
                    <div class="lec_lm_type_i_item">
                        <img src="images/dokidoki5.jpg" alt="">
                    </div>

                    <div class="lec_lm_type_i_item">
                        <img src="images/dokidoki6.jpg" alt="">
                    </div>

                    <div class="lec_lm_type_i_item">
                        <img src="images/dokidoki7.jpg" alt="">
                    </div>
        ...
        <!-- section -->
        <section id="testimonials" class="lec_section lec_section_no_overlay">
                            ...
                            <div class="lec_parallax_menu lec_image_bck lec_fixed text-center">
                                ...
                                <div class="lec_reviews_single lec_lm_type_i" data-dots="true" data-autoplay="true">
                                    ...
                                    <div class="lec_reviews_item"> 
                                       <p>Corey and I look forward to our Friday party date at DokiDoki Chocolate! Pretzels were excellent and the service was warm and friendly!</p>
                                        <svg class="svg-graphic" width="100" height="100" viewBox="0 0 100 100">
                                            <g>
                                             ...
                                             <image clip-path="url(#hexagonal-mask)" height="100px" width="100px" xlink:href="images/dokidoki9.jpg" />
                                        </svg>
                                    ...
                                    <!-- item -->
                                    <div class="lec_reviews_item"> 
                                        <p>Regardless of wether it's bloomed, droopy, burnt, or not, real chocolate is delicious, Thanks Corey!</p>
                                        
                                        <svg class="svg-graphic" width="100" height="100" viewBox="0 0 100 100">
                                             <image clip-path="url(#hexagonal-mask)" height="100px" width="100px" xlink:href="images/dokidoki10.jpg" />
                                        </svg>
                                        <strong>Brian Horton</strong>
                                    </div>
                                    
                                    <!-- item -->
                                    <div class="lec_reviews_item"> 
                                        <p>This is what happens to people who try Doki Doki Chocolate-covered pretzels. I've come to call it the doki doki face XD.</p>
                                        <svg class="svg-graphic" width="100" height="100" viewBox="0 0 100 100">
                                             <image clip-path="url(#hexagonal-mask)" height="100px" width="100px" xlink:href="images/dokidoki11.jpg" />
                                        </svg>
                                        <strong>Maureen Brouillard </strong>
                                    </div>
        ...
        <!-- section -->
        <section id="reservation" class="lec_section lec_image_bck lec_fixed lec_wht_txt" data-stellar-background-ratio="0.2" data-image="images/breeks3.jpg" data-bottom-top="@data-animation:noactive" data-200-bottom="@data-animation:active">
                ...
                <div class="container text-center">
                    ...
                    <div class="row">
                        <div class="col-md-7 lec_animation_block lec_wht_txt" data-bottom-top="transform:translate3d(0px, 40px, 0px)" data-top-bottom="transform:translate3d(0px, -40px, 0px)">
                            ...
                            <iframe height="515" src="https://www.youtube.com/embed/vBO2q23-6iU?rel=0&amp;showinfo=0" allowfullscreen></iframe>
                        </div>
